...
def sample(cfg, model, defect_info, model_version, num_images=1000, batch_size=4, steps=50):
            ...
            for origin in [ 'Real']:
                ...
                for defect_name in sorted(os.listdir(indir)):
                    ...
                    try:
                        ...
                        continue
                    outpath = osp.join(outdir, defect_name, model_version+f'_sampler_steps={steps}', 'train', 'images')
                    ...
                    for i in tqdm(range(0, num_images, batch_size)):
                        ...
                        samples, _ = sampler.sample(S=steps, batch_size=batch_size, shape=latent_shape, conditioning=batch_input, verbose=False)
