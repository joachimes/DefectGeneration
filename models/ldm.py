...
from models.latentDiff_utils.autoencoder_utils import normal_kl, DiagonalGaussianDistribution
from models.utils import exists, default

from models.vqvae import VQModelInterface
from models.vae_init import VAEInterface
...
class DDPM(LitTrainer):
    ...
    def __init__(self,
        ...
        self.model = DiffusionWrapper(unet_config, conditioning_key, num_defects=num_defects)
...
class LatentDiffusion(DDPM):
    ...
    def log_images(self, batch, N=8, n_row=4, sample=True, ddim_steps=200, ddim_eta=1., return_keys=None,
        ...
        if sample:
            ...
            if quantize_denoised and not isinstance(self.first_stage_model, VAEInterface):
                #  and not isinstance(
